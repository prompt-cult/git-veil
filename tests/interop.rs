...
//! They verify the two-way contract between git-veil and real GnuPG:
//!
//! 1. a GnuPG-generated key can be imported into our key store and then
//!    decrypt data we encrypted to it, and
//! 2. ciphertext produced by git-veil can be decrypted by GnuPG itself.
//!
...
/// generated by real GnuPG must import into the git-veil key store and decrypt
/// git-veil-produced ciphertext when the correct passphrase is supplied.
#[test]
