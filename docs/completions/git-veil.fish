...
complete -c git-veil -n "__fish_git_veil_needs_command" -f -a "import" -d 'Import your private key(s) into the git-veil key store'
complete -c git-veil -n "__fish_git_veil_needs_command" -f -a "export" -d 'Export an armoured public key from the local key store'
complete -c git-veil -n "__fish_git_veil_needs_command" -f -a "removekey" -d 'Remove a key from the local key store (destructive, local-only)'
complete -c git-veil -n "__fish_git_veil_needs_command" -f -a "trust" -d 'Verify and pin the repository owner\'s signing key (per machine)'
complete -c git-veil -n "__fish_git_veil_needs_command" -f -a "tell" -d 'Add a collaborator\'s public key to the keyring and re-sign it'
...
complete -c git-veil -n "__fish_git_veil_needs_command" -f -a "hide" -d 'Encrypt all tracked files to the keyring and delete the plaintexts'
...
complete -c git-veil -n "__fish_git_veil_needs_command" -f -a "unhide" -d 'Decrypt one tracked file back to plaintext and delete its ciphertext'
...
complete -c git-veil -n "__fish_git_veil_using_subcommand help; and not __fish_seen_subcommand_from init import export removekey trust tell removeperson add remove list hide reveal cat unhide changes show-repo-id whoami verify-keyring list-keys clean completions manpages help" -f -a "init" -d 'Initialize git-veil state (.git-veil/) in the current repository'
complete -c git-veil -n "__fish_git_veil_using_subcommand help; and not __fish_seen_subcommand_from init import export removekey trust tell removeperson add remove list hide reveal cat unhide changes show-repo-id whoami verify-keyring list-keys clean completions manpages help" -f -a "import" -d 'Import your private key(s) into the git-veil key store'
...
complete -c git-veil -n "__fish_git_veil_using_subcommand help; and not __fish_seen_subcommand_from init import export removekey trust tell removeperson add remove list hide reveal cat unhide changes show-repo-id whoami verify-keyring list-keys clean completions manpages help" -f -a "whoami" -d 'Show the identity and key store git-veil will use'
...
complete -c git-veil -n "__fish_git_veil_using_subcommand help; and not __fish_seen_subcommand_from init import export removekey trust tell removeperson add remove list hide reveal cat unhide changes show-repo-id whoami verify-keyring list-keys clean completions manpages help" -f -a "clean" -d 'Remove the .git-veil state directory (--yes required when data would be lost)'
...
complete -c git-veil -n "__fish_git_veil_using_subcommand help; and not __fish_seen_subcommand_from init import export removekey trust tell removeperson add remove list hide reveal cat unhide changes show-repo-id whoami verify-keyring list-keys clean completions manpages help" -f -a "manpages" -d 'Write roff man pages (git-veil.1 plus one per subcommand) to a directory'
